...
static emxArray_int32_T *argInit_6xUnbounded_int32_T(void)
{
  ...
  for (idx0 = 0; idx0 < 6; idx0++) {
    for (idx1 = 0; idx1 < result->size[1]; idx1++) {
      ...
      result->data[idx1 + result->size[1] * idx0] = argInit_int32_T();
    }
  }
...
static emxArray_int32_T *argInit_Unboundedx4_int32_T(void)
{
  ...
  /* Loop over the array to initialize each element. */
  for (idx0 = 0; idx0 < result->size[0]; idx0++) {
    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    i40 = argInit_int32_T();
    result->data[idx0 << 2] = i40;

    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result->data[1 + (idx0 << 2)] = i40;

    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result->data[2 + (idx0 << 2)] = argInit_int32_T();

    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result->data[3 + (idx0 << 2)] = argInit_int32_T();
  }
...
static emxArray_int32_T *argInit_Unboundedx5_int32_T(void)
{
  ...
  for (idx0 = 0; idx0 < result->size[0]; idx0++) {
    for (idx1 = 0; idx1 < 5; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result->data[idx1 + 5 * idx0] = argInit_int32_T();
    }
  }
...
static emxArray_int32_T *argInit_Unboundedx7_int32_T(void)
{
  ...
  for (idx0 = 0; idx0 < result->size[0]; idx0++) {
    for (idx1 = 0; idx1 < 7; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result->data[idx1 + 7 * idx0] = argInit_int32_T();
    }
  }
...
static emxArray_int32_T *argInit_Unboundedx8_int32_T(void)
{
  ...
  for (idx0 = 0; idx0 < result->size[0]; idx0++) {
    for (idx1 = 0; idx1 < 8; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result->data[idx1 + (idx0 << 3)] = argInit_int32_T();
    }
  }
