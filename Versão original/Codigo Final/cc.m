...
%       SOMENTE OS PESOS E FUNÇÕES DE ATIVAÇÃO CUJOS NEURONIOS ESTEJAM ATIVADOS SERÃO ATUALIZADOS COM CROSSOVER.
        while j<=numIC/2
            ...
            while true
                ...
                escolhido_1 = IC(:,min(escolhidos));    %  1º indivíduo escolhido


                escolhidos=randi(numIC,2,1); 
                escolhido_2 = IC(:,min(escolhidos));    %  2º indivíduo escolhido
                if sum(escolhido_1==escolhido_2)~=NumTOp
                    break;
                end
            ...
            if cc < taxC
                ...
                mskReal = round(rand(NumTOp,1)); % quais parâmetros reais serão alterados
            ...
            if j==1
                ...
                for k=1:(j-1)*2
                    if sum(escolhido_1==newIC(:,k))==NumTOp || sum(escolhido_2==newIC(:,k))==NumTOp
                       flag=true;
                       break;
                    end
                end
